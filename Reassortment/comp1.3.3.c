/*
 Influenza Competition model 1.3.3
 ** 1.3.3 has selection coefficient as a stochastic parameter picked from a normal distribution.
...
int main(int argc, char *argv[]) {
	...
	double s_mu = (double) strtof(smu_s, NULL);
	double s_var = (double) strtof(svar_s, NULL);
